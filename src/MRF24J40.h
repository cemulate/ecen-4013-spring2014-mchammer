...
#include <Generic.h>								// generic type defs
...
#define MRF24J40_TIMEOUT_TICKS	(78)						// 78 * 256us ticks=20ms
...
typedef struct									// radio state
{
	...
	UINT64	LastTXTriggerTick;					// tick at which we triggered the last TX packet to go out
	// error statistics
